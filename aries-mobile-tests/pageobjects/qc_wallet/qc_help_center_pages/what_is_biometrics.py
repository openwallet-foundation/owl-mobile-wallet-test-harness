...
class WhatIsBiometricsPageQC(BasePage):
    """what is Biometrics Info page object"""

    # Locators
    on_this_page_title_locator = "Biometrics"
    on_this_page_text_locator = "Explanation of what biometrics is"
