...
class StartProvingYoureAStudentPage(WebBasePage):
    """BC Wallet Showcase Start Proving You're a Student page object"""

    # Locators
    on_this_page_text_locator = "you are in the checkout process for Cool Clothes Online"
    qr_code_locator = (By.XPATH, "//div[@class='relative bg-none']//canvas")
    next_locator = (By.XPATH, "(//button[normalize-space()='NEXT'])[1]")
    proof_success_text_locator = "Success! You can continue."
